...
<template>
  <aside class="sidebar">
    <div class="fl people">
      <!-- <p>
				<img src="../../public/img/sidebar/dome2.jpg" />
			</p>-->
      <div class="planediv">
        <div class="plane">
          <div class="wings"></div>
    ...
    <menu class="fl maxbox menu">
      <ul>
        ...
        <li>
          <router-link to="/trackfile">
            <b>轨迹文件</b>
          </router-link>
        </li>
        <li>
          <router-link to="/bannedlist">
            <b>封禁名单</b>
          </router-link>
        </li>
        <li>
    ...
    <div class="sidebar_line_top">
      <img src="../../public/img/sidebar/img01.png" />
    </div>
    <div class="sidebar_line_foot">
      <img src="../../public/img/sidebar/img01.png" />
    </div>
...
.sidebar {
  ...
  max-width: 230px;
  height: 100%;
  background: url("../../public/img/sidebar/sidebar_bg.png") no-repeat center
    bottom #0f2153;
  font-size: 12px;
...
.people p {
  width: 140px;
  height: 160px;
  background: url("../../public/img/sidebar/people_bg.jpg") no-repeat;
}
.people p img {
...
.sidebar_line_right {
  ...
  width: 11px;
  height: 100%;
  background: url("../../public/img/sidebar/img02.jpg") no-repeat left center
    #15f0fa;
}
...
.plane {
  ...
  position: relative;
  color: #16f0fa;
  animation: plane-rotating 10s infinite, fly 5s infinite;
}
